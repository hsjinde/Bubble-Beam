...
const decks: Deck[] = [
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 真正的自由席只有三張：Repel（75%）、小氣球（60%），以及部分牌表改帶的 X速度或娜姿。這三格才是你按環境調整的空間。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 攻擊手的搭配是這套牌最大的變數：碧草面具厄鬼椪ex 幾乎人人都帶（95%），三蜜蜂 80%、莉佳 65%，而費洛美螂（45%）與紙御劍（35%）則是明顯的自由席，看你要對速攻還是對重砲。",
  ...
  },
  {
    ...
    energy: ["Darkness"],
    difficulty: "中",
    heroCardId: "B4-103", // 牌表裡的 Mega Sableye ex 只是 25% 採用率的單張科技，門面是胡帕ex
    ...
    strategy: [
      ...
      "- 真正的核心是呱呱泡蛙、甲賀忍蛙、胡帕ex、神奇糖果、赤日、模仿少女、精靈球、博士的研究（全數 100% 採用）與欺瞞之針（95%）。Mega勾魂眼ex 只有 25%、Mega阿勃梭魯ex 45%，屬於因人而異的最後一格。",
      "- X速度只有 55% 的牌表會帶，而且帶了的多半只放一張——如果你更習慣穩健打法，把其中一張換成小氣球或除障器都是合理的調整。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 核心固定：呱呱泡蛙、甲賀忍蛙、Mega路卡利歐ex、神奇糖果、赤日、模仿少女、精靈球、博士的研究（100% 採用），利歐路 95%、幸運蛋（Lucky Egg）90%。小果然 60%、除障器 45% 則是可調整的部分。",
