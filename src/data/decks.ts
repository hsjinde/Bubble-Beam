...
const decks: Deck[] = [
  {
    ...
    strategy: [
      ...
      "- 圖羅博士（Professor Turo）與琉琪亞（Lisia）是資源回收與檢索的關鍵潤滑劑，發動前需確認當前回合最迫切的資源需求。",
      "- 娜姿（Sabrina）與赤日（Cyrus）為收頭關鍵：強制拉出對手備戰區的殘血寶可夢進行擊殺，切忌浪費在無法造成擊殺的回合。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "水君ex 戟脊龍",
        note: "有利對局。水系弱雷，密勒頓ex 與自爆磁怪均能打出雙倍弱點傷害，且展開速度更快——把握對方戟脊龍尚未完成填能前的空檔搶分。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "不利對局。雷系弱格鬥，對方 Mega路卡利歐ex 全程打出弱點傷害。應善用娜姿與赤日打亂對手節奏，並考慮讓捷拉奧拉作為肉盾爭取時間。",
      },
      {
        vs: "甲賀忍蛙 Mega勾魂眼ex",
        note: "平手對局（五五開）。對手依靠特性每回合固定磨血，我方血線會持續受削弱——將巨大披風裝備在關鍵主力上，並在對方 Mega勾魂眼ex 成型前加速搶分。",
      },
    ],
  },
  {
    ...
    strategy: [
      "核心思路：典型的「填能引擎＋高輸出重砲」中速牌組。戟脊龍作為能量運轉核心，能讓水系主力們的展開速度大幅超越常規節奏；水君ex 提供穩定前中期輸出，古劍豹ex 則是應對高血量目標的第二把利刃。整體戰術優勢來自極佳的續航力——當對手費盡心思擊倒第一隻主力時，第二隻重砲早已填滿能量準備登場。",
      "展開順序：首回合務必讓涼脊龍落地，將神奇糖果直上戟脊龍列為最優先資源投注。引擎成型前先用水君ex 前場頂線並自然累積能量；引擎運轉後，每回合需通盤考量「當前能量分配與下回合輪轉順序」，維持雙主力的持續進攻。",
      "注意事項：",
      "- 兩張巨大披風能使水君ex 的耐久達到「多承受一次攻擊」的臨界點，搭配寶可夢中心姐姐的回血可打出強力的消耗戰。",
      "- 最大威脅為雷系（弱點）：面對密勒頓體系時，建議讓非 ex 的戟脊龍多承擔前場防禦工作，減少送分（獎賞卡）。",
      "- 充氣小艇與開始的平原提供靈活的機動力與場面支援，逆風時應優先鞏固生存能力。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "密勒頓ex 自爆磁怪",
        note: "不利對局。水系弱雷，全隊皆面臨弱點打擊。應盡量利用回血與巨大披風拉長戰線，逼迫對方耗盡資源，並運用非 ex 寶可夢前排坦傷以減少獎賞卡損失。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "有利對局。我方重砲輸出能有效涵蓋對方主力血線，且對方無弱點壓制優勢；只需穩住填能引擎按部就班進行輪轉即可。",
      },
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
        note: "小幅不利。對方跳級成型通常快半拍，且有手裏劍點傷威脅引擎；需優先保護涼脊龍與戟脊龍，只要填能鏈不斷即有勝算。",
      },
    ],
  },
  {
    ...
    strategy: [
      ...
      "- 火焰貼紙需要棄牌區有火能量才能發動，適時利用博士的研究或模仿少女進行棄牌過濾。",
      "- 留意水系隊伍（如水君ex 戟脊龍）的弱點威脅，對上水系時需注意前場血線防護。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "水君ex 戟脊龍",
        note: "不利對局。火系弱水，對面水君ex 與古劍豹ex 打你都是弱點傷害。需把握對方戟脊龍成型前的空檔，靠糖果速成 Mega火焰雞ex 搶先擊殺對手關鍵單位。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
      ...
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
        note: "有利對局。草系弱火，Mega火焰雞ex 攻擊皆為弱點雙倍傷害，能輕鬆碾壓對手主砲。",
      },
    ],
  },
  {
    ...
    strategy: [
      ...
      "- 小氣球能大幅提升重裝主砲的機動性，撤退時機往往比硬多打一下更為關鍵。",
      "- 岩石頭盔掛在頂線寶可夢身上，能讓對方輕型攻擊手在互換時十分划不來。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "甲賀忍蛙 Mega勾魂眼ex",
        note: "有利對局。惡系弱草，Mega蜥蜴王ex 對其主力全為弱點擊打，且我方忍蛙在對磨手裏劍時毫不遜色。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
        note: "五五開。比拚誰先立好主砲——善用忍蛙的削血逼迫對方密勒頓ex 提早退場，避免讓自爆磁怪安穩成型。",
      },
      {
        vs: "水君ex 戟脊龍",
        note: "小幅有利。對方供能需要時間，我方糖果路線通常更快；注意避免讓古劍豹ex 抓住我方集能空檔。",
      },
    ],
  },
  {
    ...
    strategy: [
      "核心思路：具備極高彈性與干擾力的惡系體系。索羅亞克ex 擁有複製並借用招式的靈活能力，能根據敵方前場寶可夢隨時調整輸出方式；Mega阿勃梭魯ex 則能在高 HP 基礎上給予對手巨大的場面壓力，並干擾對手資源與手牌。配合毛毛角羊、達克萊伊ex 與毛球小鳥，能靈活應對各種複雜對局。",
      "展開順序：開局優先鋪設索羅亞並快速附能。達克萊伊ex 或毛球小鳥可用於前期站場過渡。適時進化索羅亞克ex 與 Mega阿勃梭魯ex，並善用巨大披風或岩石頭盔增強前場互換能力。",
      "注意事項：",
      "- 索羅亞克ex 的招式選擇極度考驗玩家對賽場主流對手的了解，需精確計算傷害與附加效果。",
      "- 岩石頭盔與巨大披風的裝備對象需根據敵方主力攻擊手靈活調整。",
    ...
    matchups: [
      ...
      {
        vs: "Mega路卡利歐ex",
        note: "不利對局。惡系弱格鬥，Mega路卡利歐ex 會打出弱點傷害。必須靠干擾牌與拉後排戰術避開正面對轟。",
      },
      {
        vs: "Mega七夕青鳥ex 太陽伊布",
  ...
  },
  {
    ...
    strategy: [
      "核心思路：以高血量與防守恢復為特色的中速牌組。Mega七夕青鳥ex（Mega Altaria ex）擁有極佳的血量與穩定的攻擊面板，太陽伊布（Espeon）則提供強大的解場與支援能力。整套牌組擅長打消耗戰，讓對手無法在一回合內擊倒主砲，再透過高續航力逆轉局面。",
    ...
    matchups: [
      ...
      {
        vs: "水君ex 戟脊龍",
        note: "有利對局。對方中速消耗戰打不過七夕青鳥的高耐久與恢復，按部就班進攻即可穩定獲勝。",
      },
      {
        vs: "Mega路卡利歐ex",
  ...
  },
  {
    ...
    strategy: [
      ...
      "注意事項：",
      "- 防護斗篷與巨大披風是保護愛管侍ex 與騎拉帝納ex 不被對方娜姿拉出秒殺的關鍵卡牌。",
      "- 幸運冰棒（Lucky Ice Pop）與寶可夢中心姐姐能極大化愛管侍ex 的戰術恢復價值。",
      "- 開始的平原提供撤退與機動性，靈活切換前場寶可夢。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "密勒頓ex 自爆磁怪",
      ...
      {
        vs: "索羅亞克ex Mega阿勃梭魯ex",
        note: "不利對局。對方惡系弱點傷害極高，需儘快讓騎拉帝納ex 登場一擊必殺。",
      },
    ],
  },
  {
    ...
    strategy: [
      "核心思路：具備極高穩定度與防守控場能力的水系牌組。伊布ex 提供了優秀的起手展開與抽牌流暢度，醜醜魚可迅速進化為美納斯ex（Milotic ex）。美納斯ex 具備優異的限制效果與穩定輸出，配合米可利（Wallace）的專屬支援，能大幅干擾對手的攻擊節奏。",
      "展開順序：起手優先以伊布ex 或醜醜魚開局。伊布ex 進行鋪場與抽牌，迅速搜尋美納斯ex 進化線。古劍豹ex 可作為備用大招或後期壓制工具。",
      "注意事項：",
      "- 米可利能大幅強化美納斯ex 的防禦與戰術限制，在關鍵回合使用能直接封鎖敵方攻擊。",
    ...
    matchups: [
      {
        vs: "Mega火焰雞ex 甲賀忍蛙",
        note: "有利對局。水系剋制火系，美納斯ex 與古劍豹ex 對火焰雞皆能造成弱點雙倍傷害。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
        note: "不利對局。雷系弱點壓制，需依賴伊布ex 高彈性與米可利干擾來爭取勝機。",
      },
      {
        vs: "水君ex 戟脊龍",
  ...
  },
  {
    ...
    strategy: [
      "核心思路：結合達克萊伊ex（Darkrai ex）每回合免費放置傷害指示物的特性，與騎拉帝納ex（Giratina ex）頂級單體傷害的雙神體系。達克萊伊在備戰區持續削弱敵方全場血線，騎拉帝納ex 則在前場進行無情打擊，讓對手難以計算血量安全線。",
      "展開順序：開局起手達克萊伊ex 或騎拉帝納ex 皆可。達克萊伊ex 儘早落地發動特性削血，手牌利用博士的研究與模仿少女快速濾牌，幫騎拉帝納ex 填滿能量。",
      "注意事項：",
    ...
    matchups: [
      {
        vs: "Mega七夕青鳥ex 太陽伊布",
        note: "有利對局。達克萊伊ex 的惡系傷害能對超能系造成弱點打擊，騎拉帝納ex 亦能輕鬆收割殘血。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "不利對局。達克萊伊ex 弱格鬥，需盡量讓騎拉帝納ex 承擔頂線，避開達克萊伊被對手路卡利歐秒殺。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
  ...
  },
  {
    ...
    strategy: [
      "核心思路：結合甲賀忍蛙（Greninja）的後排遠程點傷與 Mega阿勃梭魯ex（Mega Absol ex）高輸出干擾的控制流牌組。忍蛙的「飛水手裏劍」每回合削弱敵人，配合鈴噹響限制道具與 Mega阿勃梭魯ex 破壞戰線，能令對手處於極度被動的狀態。",
    ...
    matchups: [
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
        note: "不利對局。惡系弱草，對手 Mega蜥蜴王ex 打你全隊都是雙倍弱點傷害，需靠赤日與忍蛙點傷打亂對方進化。",
      },
      {
        vs: "水君ex 戟脊龍",
      ...
      {
        vs: "Mega七夕青鳥ex 太陽伊布",
        note: "小幅有利。惡系對超能系的弱點優勢顯著，能迅速打破對方的防守體系。",
      },
    ],
  },
  {
    ...
    strategy: [
      ...
      "- 娜姿＋赤日雙干擾在單核牌裡價值加倍：對手永遠不知道下回合誰會被拖出來。",
      "- 入門推薦：卡片職責清楚、路線單一，適合當你踏入現環境的第一套牌。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "密勒頓ex 自爆磁怪",
        note: "有利對局。雷系弱格鬥，主砲全程弱點傷害；注意對方速度快，前兩回合先用副攻擊手穩住，別讓主砲沒成型就被圍攻。",
      },
      {
        vs: "水君ex 戟脊龍",
        note: "不利對局。對方重砲＋回血的消耗戰你打不贏，速戰速決：趁引擎成型前用飛腿郎點殘關鍵位，搶前三分。",
      },
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
  ...
  },
  {
    ...
    matchups: [
      {
        vs: "水君ex 戟脊龍",
        note: "有利對局。水系弱雷，Mega雷電獸ex 與捷拉奧拉皆能打出弱點傷害，速度遠快於對方。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "不利對局。雷系弱格鬥，對方 Mega路卡利歐ex 能輕鬆一擊帶走你的前場。需靠娜姿與捷拉奧拉後排狙擊繞開正面。",
      },
      {
        vs: "Mega火焰雞ex 甲賀忍蛙",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 琉琪亞與莉莉艾能提供穩健的手牌檢索，確保七夕青鳥進化鏈不卡牌。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "Mega火焰雞ex 甲賀忍蛙",
        note: "有利對局。鈴噹響封鎖對手的神奇糖果，使其火焰雞無法順利進化，為你贏得絕對時間差。",
      },
      {
        vs: "索羅亞克ex Mega阿勃梭魯ex",
        note: "不利對局。惡系對超能系造成弱點傷害，對方不需要依賴糖果即可快速輸出。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
  ...
  },
  {
    ...
    difficulty: "易",
    summary:
      "純格直球強攻：簡化進化線，滿載飛腿郎與多麗米亞輔護前場，集中資源讓 Mega路卡利歐ex 強攻破局。",
    cards: [
      { id: "A2-91", count: 1 }, // Riolu (A2)
    ...
    strategy: [
      ...
      "展開順序：利歐路開局落地，利用柯爾妮（Korrina）或精靈球檢索 Mega路卡利歐ex。飛腿郎可於前期對敵方備戰區進行點傷削血。",
      "注意事項：",
    ...
    matchups: [
      {
        vs: "密勒頓ex 自爆磁怪",
        note: "有利對局。雷系弱格鬥，Mega路卡利歐ex 的攻擊能直接一擊秒殺密勒頓ex。",
      },
      {
        vs: "水君ex 戟脊龍",
        note: "不利對局。水君ex 搭配戟脊龍的續航能力高於單核路卡利歐，需靠飛腿郎前期打殘對手涼脊龍。",
      },
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
  ...
  },
  {
    ...
    strategy: [
      ...
      "注意事項：",
      "- 希特隆（Clemont）與琉琪亞能為雷系隊伍提供極高價值的能量與檢索過濾。",
    ...
    matchups: [
      {
        vs: "水君ex 戟脊龍",
        note: "有利對局。水系弱雷，自爆磁怪一擊即可帶走水君ex，且只給對方 1 分獎賞。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "不利對局。雷系弱格，對方路卡利歐能輕易秒殺前場，需靠花舞鳥與控場干擾拖延。",
      },
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 圖羅博士（Professor Turo）可用於回收殘血的 ex 寶可夢，防止對手拿到關鍵 2 分獎賞卡。",
      "- 留意格鬥系弱點，避免前場被 Mega路卡利歐強行擊破。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "水君ex 戟脊龍",
        note: "有利對局。雷系弱點對水系隊伍有絕對壓制，自爆磁怪ex 的超高血量對方極難一擊必殺。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "不利對局。弱點傷害過高，需盡早靠密勒頓ex 搶攻打亂對方節奏。",
      },
      {
        vs: "Mega七夕青鳥ex 太陽伊布",
        note: "五五開。雙方都是高 HP 中速對決，比拚資源管理與圖羅博士回收時機。",
      },
    ],
  },
  {
    ...
    matchups: [
      {
        vs: "Mega火焰雞ex 甲賀忍蛙",
        note: "有利對局。水系雙倍弱點傷害，古劍豹ex 拔刀能一擊秒殺火焰雞。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
        note: "不利對局。雷系弱點過於致命，需利用美納斯ex 的控制招式封鎖對方攻擊。",
      },
      {
        vs: "Mega路卡利歐ex",
  ...
  },
  {
    ...
    matchups: [
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
        note: "有利對局。草系弱火，Mega噴火龍Y ex 打出天際雙倍傷害，輕鬆橫掃對戰區。",
      },
      {
        vs: "水君ex 戟脊龍",
        note: "不利對局。弱點水系威脅極大，需靠火焰貼紙極速養出噴火龍，在對方水君攻擊前搶先擊殺。",
      },
      {
        vs: "Mega路卡利歐ex",
  ...
  },
  {
    ...
    matchups: [
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
        note: "有利對局。火系剋制草系，極速跳級的 Mega火焰雞ex 能對蜥蜴王造成毀滅性雙倍打擊。",
      },
      {
        vs: "水君ex 戟脊龍",
        note: "不利對局。弱點水系，對方戟脊龍成型後水君傷害過高，需靠速度優勢搶前三分。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
  ...
  },
  {
    ...
    matchups: [
      {
        vs: "Mega七夕青鳥ex 太陽伊布",
        note: "有利對局。惡系對超能系弱點雙倍，三首惡龍與 Mega勾魂眼ex 能輕鬆打穿對手防線。",
      },
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
        note: "不利對局。惡系弱草，對手 Mega蜥蜴王ex 的攻擊能對你的主力造成雙倍打擊。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
  ...
  },
  {
    ...
    strategy: [
      ...
      "注意事項：",
      "- 每回合結束前重新算一次對手全場血線，手裏劍的 20 點點傷常常決定下回合能否完成關鍵雙殺。",
      "- 這套牌怕草系（弱點）與極速快攻：對面節奏太快時別貪展開，先確保前場不崩盤。",
      "- 赤日把對手縮在備戰區的重傷寶可夢強制拉出來，是這套牌最常見的致勝一擊。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "Mega蜥蜴王ex 甲賀忍蛙",
        note: "不利對局。惡系弱草，對方主砲全程打你弱點，而且對方也有忍蛙跟你互磨。盡量搶先手削血，把節奏拖進你的收割回合。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
  ...
  },
  {
    ...
    difficulty: "中",
    summary:
      "惡系的基礎寶可夢代表：兩張胡帕ex 撐起主線輸出，達克萊伊ex 與 Mega阿勃梭魯ex 負責補刀與破壞戰線。",
    cards: [
      { id: "B4-103", count: 2 }, // Hoopa ex
      { id: "A2-110", count: 1 }, // Darkrai ex
      { id: "B1-151", count: 1 }, // Mega Absol ex
      { id: "PROMO-A-7", count: 2 }, // Professor's Research
      { id: "A2-150", count: 2 }, // Cyrus
      { id: "B1-225", count: 2 }, // Copycat
      { id: "PROMO-A-5", count: 2 }, // Poké Ball
      { id: "B2-145", count: 2 }, // Lucky Ice Pop
      { id: "A3a-64", count: 1 }, // Repel
      { id: "B3-147", count: 1 }, // Field Blower
      { id: "B4-148", count: 2 }, // Deceptive Needle
      { id: "B3b-64", count: 1 }, // Small Balloon
      { id: "B2-154", count: 1 }, // Starting Plains
    ],
    strategy: [
      "核心思路：惡系體系的集大成者。它不靠進化線，全隊都是基礎寶可夢——這代表沒有「被打斷進化就崩盤」的軟肋，開局第二回合就能開始交換。兩張胡帕ex（Hoopa ex）是主要輸出來源，達克萊伊ex（Darkrai ex）提供不需上場也能運作的削血，Mega阿勃梭魯ex（Mega Absol ex）則是破壞對手節奏與收尾的第三張王牌。",
      ...
      "注意事項：",
      "- 這套牌的固定班底非常明確：胡帕ex、達克萊伊ex、Mega阿勃梭魯ex、赤日、模仿少女、博士的研究與兩張欺瞞之針，在取樣牌表中都是 100% 採用；精靈球 95%、兩張幸運冰棒 90%、除障器（Field Blower）85%、開始的平原 80%。抄牌時這一段不要動。",
      "- 真正的自由席只剩一格：X速度（30%）。小氣球 75%、Repel 65% 與 Pokémon Center Lady 55% 屬於多數牌表會帶的常見牌，這幾張加上 X速度才是你按環境調整的空間。",
      "- 兩張赤日不是湊數，把它當「第二把主砲」用：胡帕ex 打前場、赤日把備戰區的殘血目標拉出來清掉。這套牌沒有遠程點傷，所有的收頭都靠這兩張。",
      "- 最大的天敵是草系（惡系弱草）。對上草系時別硬碰前場，改用赤日與削血從備戰區拆對方的進化雛型。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "蜂女王ex 壺壺ex",
        note: "不利對局。惡系弱草，對方主力打你都是雙倍傷害，而且對方同樣是高使用率的一線牌。唯一的活路是速度：趁對方披風與場地卡疊起來之前，用赤日＋削血搶先拆掉關鍵攻擊手。",
      },
      {
        vs: "Mega七夕青鳥ex 太陽伊布",
        note: "有利對局。超能系弱惡，你的主砲全程打弱點；注意對方回血與防護道具會拖長戰線，收頭的赤日要留住不要提前用掉。",
      },
      {
        vs: "自爆磁怪ex 自爆磁怪",
        note: "五五開。對方要靠進化線成型，你是全基礎寶可夢的快節奏——把削血打在小磁怪身上，逼對方在「進化」與「保命」之間二選一。",
      },
    ],
  },
  {
    ...
    cards: [
      { id: "B4-10", count: 2 }, // Combee
      { id: "B4-11", count: 2 }, // Vespiquen ex
      { id: "A4-21", count: 1 }, // Shuckle ex
      { id: "B2-17", count: 1 }, // Teal Mask Ogerpon ex
      { id: "A3a-7", count: 1 }, // Pheromosa
      { id: "A3a-8", count: 1 }, // Kartana
      { id: "PROMO-A-7", count: 2 }, // Professor's Research
      { id: "B1-225", count: 2 }, // Copycat
      { id: "A1-219", count: 1 }, // Erika
      { id: "A2-150", count: 1 }, // Cyrus
      { id: "PROMO-A-2", count: 1 }, // X Speed
      { id: "B3-147", count: 1 }, // Field Blower
      { id: "A3-147", count: 2 }, // Leaf Cape
      { id: "B3-153", count: 2 }, // Fragrant Forest
    ],
    strategy: [
      "核心思路：草系使用率最高的一線牌，走的是草系少見的「耐久消耗」路線。蜂女王ex（Vespiquen ex）是唯一需要進化的主線，其餘全是可以直接落地的攻擊手；兩張樹葉披風（Leaf Cape）與兩張芬芳森林（Fragrant Forest）把整隊的有效血線往上推一整個檔次，配合莉佳（Erika）的草系專屬回復，讓對手往往要多花一到兩回合才能拿下一分——而這兩回合就是你反打的窗口。",
      "展開順序：首回合把三蜜蜂鋪下去並附能，第二隻基礎寶可夢依對局選擇：需要頂線就放壺壺ex（Shuckle ex），需要壓速度就放碧草面具厄鬼椪ex 或紙御劍。蜂女王ex 進化完成後立刻掛上樹葉披風，之後每回合的判斷都圍繞同一件事——「對手這回合能不能打死我」，答案是不能的話就繼續攻擊，是的話就先補血或換人。",
      "注意事項：",
      "- 核心不可動的部分：兩張蜂女王ex、一張壺壺ex（多數牌表其實帶兩張）、兩張樹葉披風、兩張芬芳森林、赤日、模仿少女、博士的研究、X速度，取樣牌表全數 100% 採用。",
      "- 攻擊手的搭配是這套牌最大的變數：碧草面具厄鬼椪ex 已經人人都帶（100%）、三蜜蜂 95%，反倒是莉佳掉到 15%，費洛美螂與紙御劍則整個掉出 15% 的統計門檻。現在能動的空間主要剩下要不要補一張蜂女王（15%）。",
      "- 別把披風全押在同一隻身上。這套牌贏在「每一隻都不好殺」，分散掛比疊在主砲上更難處理。",
      "- 火系是唯一真正的硬傷（草系弱火）。對上火系請放棄消耗戰，改打交換比：用非 ex 的攻擊手換掉對方主砲，讓對方的獎賞卡數字追不上。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "胡帕ex Mega阿勃梭魯ex",
        note: "有利對局。惡系弱草，你的主力全程打雙倍傷害。要小心的是對方兩張赤日的收頭能力——備戰區別留殘血目標給他拉。",
      },
      {
        vs: "Mega火焰雞ex 甲賀忍蛙",
        note: "不利對局。草系弱火，對方一發就能帶走你辛苦養起來的主砲。唯一解法是搶在對方用神奇糖果跳級之前壓死節奏，並優先處理備戰區的火稚雞。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "五五開。雙方都沒有弱點優勢，比的是「披風與回血」對上「單體爆發」。把樹葉披風留給要接對方主砲那一擊的寶可夢，別提前用掉。",
      },
    ],
  },
  {
    ...
    energy: ["Darkness"],
    difficulty: "中",
    heroCardId: "B4-103", // 牌表裡的 Mega Sableye ex 只是 35% 採用率的單張科技，門面是胡帕ex
    summary: "胡帕ex 的敏捷版本：捨棄 Mega 主砲，改用甲賀忍蛙的飛水手裏劍每回合補刀壓線。",
    cards: [
      { id: "A1-87", count: 2 }, // Froakie
      { id: "A1-89", count: 2 }, // Greninja
      { id: "B4-103", count: 2 }, // Hoopa ex
      ...
      { id: "PROMO-A-5", count: 2 }, // Poké Ball
      { id: "A3-144", count: 2 }, // Rare Candy
      { id: "PROMO-A-2", count: 2 }, // X Speed
      { id: "B4-148", count: 2 }, // Deceptive Needle
    ],
    strategy: [
      "核心思路：與「胡帕ex Mega阿勃梭魯ex」同樣以胡帕ex 為主砲，但取捨完全相反。那一套把後兩格交給達克萊伊ex 與 Mega阿勃梭魯ex，靠單點爆發收頭；這一套改成呱呱泡蛙加神奇糖果跳級甲賀忍蛙，用特性「飛水手裏劍」每回合免費打 20 點，把對手的血線持續壓進胡帕ex 的一擊必殺區間。犧牲的是後期的單發上限，換到的是更快、更穩定、也更便宜的節奏——這也是它比 Mega 版本容易上手的原因。",
      "展開順序：呱呱泡蛙與胡帕ex 同時開局，神奇糖果優先給忍蛙——忍蛙一旦成型，之後每回合的 20 點是白拿的。兩張 X速度讓胡帕ex 可以自由進出前場，打完就換、換完再打。牌表中那張 Mega勾魂眼ex 不是主線，只是留給長考對局的備案，抽不到完全不影響運轉。",
      "注意事項：",
      "- 手裏劍的價值在於「兩回合總傷害」：出手前先算清楚這回合打完、下回合再補 20 點能不能剛好收掉目標，別把胡帕ex 的攻擊浪費在差 10 點的血線上。",
      "- 真正的核心是呱呱泡蛙、甲賀忍蛙、胡帕ex、神奇糖果、赤日、模仿少女、精靈球、博士的研究與欺瞞之針。Mega勾魂眼ex 與 Mega阿勃梭魯ex 屬於因人而異的最後一格。",
      "- X速度多數牌表會帶，而且帶了的多半直接放兩張——如果你更習慣穩健打法，把其中一張換成小氣球或除障器都是合理的調整。",
      "- 一樣要避開草系。忍蛙的點傷在劣勢對局特別重要：即使前場一直被壓著打，備戰區的手裏劍仍在替你累積擊殺線。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "胡帕ex Mega阿勃梭魯ex",
        note: "五五開的同族對決。對方單發更重、你出手更快——比的是你能不能在對方 Mega阿勃梭魯ex 登場前，用手裏劍把兩隻胡帕ex 都壓進擊殺線。",
      },
      {
        vs: "Mega七夕青鳥ex 太陽伊布",
        note: "有利對局。超能系弱惡，胡帕ex 全程打弱點，而忍蛙的點傷正好剋制對方靠回血站樁的打法。",
      },
      {
        vs: "蜂女王ex 壺壺ex",
        note: "不利對局。惡系弱草，加上對方披風與回血堆得比你的手裏劍快。務必搶先手，並用赤日直接處理還沒進化完成的三蜜蜂。",
      },
    ],
  },
  {
    ...
    difficulty: "中",
    summary:
      "雷系雙線快攻：落雷獸直接進化 Mega雷電獸ex，光電傘蜥接棒續航，希特隆體系保證附能不斷。",
    cards: [
      { id: "PROMO-B-43", count: 2 }, // Electrike
      { id: "B2b-27", count: 2 }, // Mega Manectric ex
      { id: "B1a-28", count: 2 }, // Helioptile
      { id: "B4-61", count: 2 }, // Heliolisk
      { id: "B1a-68", count: 2 }, // Clemont
      { id: "B1a-66", count: 2 }, // Clemont's Backpack
      { id: "PROMO-A-7", count: 2 }, // Professor's Research
      { id: "A2-150", count: 1 }, // Cyrus
      { id: "B1-225", count: 1 }, // Copycat
      { id: "PROMO-A-5", count: 2 }, // Poké Ball
      { id: "B3-147", count: 1 }, // Field Blower
      { id: "B3b-65", count: 1 }, // Elegant Cape
    ],
    strategy: [
      "核心思路：把既有的「Mega雷電獸ex 捷拉奧拉」升級成雙進化線的版本。Mega雷電獸ex 仍是速度最快的 Mega 之一（落雷獸可以直接進化，不需要神奇糖果），但副手從零撤退的捷拉奧拉換成了光電傘蜥（Heliolisk）——輸出更高、也更能撐住第二輪交換。真正讓這套牌站上一線的是兩張希特隆（Clemont）加兩張希特隆的背包（Clemont's Backpack）組成的支援包：檢索與附能同時解決，讓兩條進化線都不會卡手。",
      ...
      "- 自由席比想像中多：除障器 80%、優雅披風（Elegant Cape）75%、訓練場（Training Area）60%，落雷獸則在 B2b 版（60%）與 promo 版（45%）之間各家取捨。這代表牌表細節可以按手感調整，但兩條進化線的「終點」不能少。",
    ...
    matchups: [
      {
        vs: "水君ex 戟脊龍",
        note: "有利對局。水系弱雷，而且你的速度遠快於對方的填能引擎——趁涼脊龍還沒進化成戟脊龍時就要把分數搶到手。",
      },
      {
        vs: "Mega路卡利歐ex",
        note: "不利對局。雷系弱格鬥，對方一擊就能帶走你的主砲。把希特隆的資源優先用在鋪第二條進化線上，靠交換數量拖到對方主砲下場。",
      },
      {
        vs: "蜂女王ex 壺壺ex",
        note: "五五開。雙方沒有弱點關係，比的是你的爆發能不能追上對方的回血。優先打斷三蜜蜂的進化，別讓對方把披風疊滿。",
      },
    ],
  },
  {
    ...
    cards: [
      { id: "A2-91", count: 2 }, // Riolu
      { id: "B3-81", count: 1 }, // Mega Lucario ex
      { id: "A1-87", count: 2 }, // Froakie
      { id: "A1-89", count: 2 }, // Greninja
      { id: "B4-74", count: 2 }, // Wynaut
      { id: "PROMO-A-7", count: 2 }, // Professor's Research
      { id: "B1-225", count: 2 }, // Copycat
      { id: "A2-150", count: 1 }, // Cyrus
      { id: "PROMO-A-5", count: 2 }, // Poké Ball
    ...
    strategy: [
      "核心思路：與純格鬥的「Mega路卡利歐ex」是同一張主砲、完全不同的思路。純格版本靠一堆單張道具堆出正面壓制；這一套把那些格子換成呱呱泡蛙加甲賀忍蛙的削血引擎與兩張小果然（Wynaut）。你不再需要每回合都用主砲打死人——忍蛙的手裏劍會把血線壓下來，主砲只負責最後那一下。這裡收錄的牌表帶一張 Mega路卡利歐ex（多數牌表其實帶兩張），少的那一張正是換成了忍蛙的進化線。",
      "展開順序：利歐路與呱呱泡蛙同時鋪場，兩張神奇糖果依對局決定先給誰：對手速度快就先跳忍蛙拿到每回合的點傷，對手是重砲就先立主砲搶先手。小果然在前期用來頂線與過渡，讓主砲不必提早暴露在對方的射程裡。",
      "注意事項：",
      "- 這套牌難度高於純格版本，難就難在兩張神奇糖果的分配：忍蛙與主砲都想要，而糖果給錯順序通常等於整局慢一拍。手上只有一張時，先問「這回合我需要的是持續點傷還是一發重擊」。",
      "- 核心固定：呱呱泡蛙、甲賀忍蛙、Mega路卡利歐ex、神奇糖果、赤日、模仿少女、精靈球、博士的研究，再加上利歐路與幸運蛋（Lucky Egg）。小果然與除障器則是可調整的部分。",
      "- 幸運蛋掛在會被打倒的那一隻身上，補牌的節奏往往決定你能不能立起第二波攻勢。",
      "- 忍蛙的 20 點點傷讓「對方剩 20–30 血就退到後排」這種常見保命操作失效，配合赤日就是穩定的兩分。",
    ].join("\n\n"),
    matchups: [
      {
        vs: "Mega路卡利歐ex",
        note: "同族對照的五五開。對方兩張主砲、道具更厚，你則多了每回合的手裏劍。打法很明確：別跟對方換前場，靠點傷累積優勢，讓對方的第二張主砲派不上用場。",
      },
      {
        vs: "密勒頓ex 自爆磁怪",
        note: "有利對局。雷系弱格鬥，主砲全程打弱點；前期用小果然與忍蛙頂住對方的搶攻，等主砲跳級完成再一口氣收下。",
      },
      {
        vs: "水君ex 戟脊龍",
        note: "不利對局。對方血厚又有回血，你只有一張主砲打不動消耗戰。改把忍蛙的點傷全數壓在涼脊龍身上，斷掉對方的填能引擎才有機會。",
      },
    ],
  },
];
