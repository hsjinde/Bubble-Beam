...
const decks: Deck[] = [
  ...
  },
  {
    ...
    difficulty: "中",
    summary:
      "現環境的惡系標竿：兩張胡帕ex 撐起主線輸出，達克萊伊ex 與 Mega阿勃梭魯ex 負責補刀與破壞戰線。",
    cards: [
    ...
    strategy: [
      ...
      "注意事項：",
      "- 這套牌的固定班底非常明確：胡帕ex、達克萊伊ex、Mega阿勃梭魯ex、赤日、模仿少女、精靈球、博士的研究、除障器（Field Blower）、兩張欺瞞之針與兩張幸運冰棒，在取樣牌表中都是 100% 採用；開始的平原 90%。抄牌時這一段不要動。",
      "- 真正的自由席只剩兩格：小氣球（60%）與部分牌表改帶的 X速度（40%）——Repel 已經漲到 90% 採用，實質上跟固定班底同級。這兩格才是你按環境調整的空間。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 攻擊手的搭配是這套牌最大的變數：碧草面具厄鬼椪ex 幾乎人人都帶（90%），三蜜蜂 90%、莉佳 50%，而費洛美螂（35%）與紙御劍（30%）則是明顯的自由席，看你要對速攻還是對重砲。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 真正的核心是呱呱泡蛙、甲賀忍蛙、胡帕ex、神奇糖果、赤日、模仿少女、精靈球、博士的研究與欺瞞之針（全數 100% 採用）。Mega勾魂眼ex 只有 35%、Mega阿勃梭魯ex 45%，屬於因人而異的最後一格。",
      "- X速度有 60% 的牌表會帶，而且帶了的多半直接放兩張——如果你更習慣穩健打法，把其中一張換成小氣球或除障器都是合理的調整。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "注意事項：",
      "- 固定班底：兩張 Mega雷電獸ex、兩張光電傘蜥、兩張希特隆、兩張希特隆的背包、博士的研究、精靈球（皆 100% 採用），加上 95% 採用的優雅披風（Elegant Cape）。",
      "- 自由席比想像中多：傘電蜥 80%、落雷獸 70%，另有各約 40% 的牌表會改帶米可利（May）、訓練場（Training Area），或把落雷獸換成 B2b 版的那張。這代表牌表細節可以按手感調整，但兩條進化線的「終點」不能少。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 核心固定：呱呱泡蛙、甲賀忍蛙、Mega路卡利歐ex、神奇糖果、赤日、模仿少女、精靈球、博士的研究（100% 採用），利歐路 90%、幸運蛋（Lucky Egg）80%。小果然 50%、除障器 65% 則是可調整的部分。",
