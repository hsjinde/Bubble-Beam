...
const decks: Deck[] = [
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 攻擊手的搭配是這套牌最大的變數：碧草面具厄鬼椪ex 已經人人都帶（100%）、三蜜蜂 95%，反倒是莉佳掉到 15%，費洛美螂與紙御劍則整個掉出 15% 的統計門檻。現在能動的空間主要剩下要不要補一張蜂女王（35%）。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "- 自由席其實不多：優雅披風（Elegant Cape）與除障器都到 90%、訓練場（Training Area）80%，落雷獸則在 B2b 版（75%）與 promo 版（35%）之間各家取捨。這代表牌表細節可以按手感調整，但兩條進化線的「終點」不能少。",
