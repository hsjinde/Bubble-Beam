...
const decks: Deck[] = [
  ...
  },
  {
    ...
    energy: ["Grass"],
    difficulty: "中",
    summary: "草系主力：神奇糖果直上 Mega蜥蜴王ex，甲賀忍蛙特性每回合補刀。",
    cards: [
    ...
    strategy: [
      "核心思路：草系的主流牌組之一。主線戰術是用神奇糖果讓木守宮直接跳級成 Mega蜥蜴王ex 擔綱主砲；副線則讓呱呱泡蛙同樣走糖果路線進化出甲賀忍蛙，靠特性「飛水手裏劍」每回合免費輸出點傷，幫主砲把擊殺線壓進射程。",
  ...
  },
  {
    ...
    strategy: [
      ...
      "注意事項：",
      "- 這套牌的固定班底非常明確：胡帕ex、達克萊伊ex、Mega阿勃梭魯ex、赤日、模仿少女、博士的研究與兩張欺瞞之針，再加上除障器（Field Blower）、精靈球、兩張幸運冰棒與開始的平原。抄牌時這一段不要動。",
      "- 真正的自由席只剩一格：X速度。小氣球、Repel 與 Pokémon Center Lady 屬於多數牌表會帶的常見牌，這幾張加上 X速度才是你按環境調整的空間。",
  ...
  },
  {
    ...
    energy: ["Grass"],
    difficulty: "中",
    summary: "草系一線的耐久牌：蜂女王ex 主線輸出，樹葉披風與芬芳森林堆出誇張耐久。",
    cards: [
    ...
    strategy: [
      "核心思路：草系的一線牌之一，走的是草系少見的「耐久消耗」路線。蜂女王ex（Vespiquen ex）是唯一需要進化的主線，其餘全是可以直接落地的攻擊手；兩張樹葉披風（Leaf Cape）與兩張芬芳森林（Fragrant Forest）把整隊的有效血線往上推一整個檔次，配合莉佳（Erika）的草系專屬回復，讓對手往往要多花一到兩回合才能拿下一分——而這兩回合就是你反打的窗口。",
      ...
      "- 攻擊手的搭配是這套牌最大的變數：碧草面具厄鬼椪ex 已經人人都帶（100%）、三蜜蜂 90%，反倒是莉佳、費洛美螂與紙御劍都整個掉出 15% 的統計門檻。現在能動的空間主要剩下要不要補一張蜂女王（30%）。",
