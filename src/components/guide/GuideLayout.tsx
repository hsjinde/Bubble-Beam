    ...
    <div className="min-h-screen bg-[#eef7fc]">
      <header className="sticky top-0 z-40 border-b border-[#bfe3f5] bg-white/90 backdrop-blur">
        ...
        <nav className="mx-auto flex max-w-5xl items-center gap-6 px-4 py-2">
          <Link
            to="/"
            className="inline-flex min-h-11 items-center text-lg font-bold text-[#2a6f97]"
          >
            Piplup!
          </Link>
          <Link
            to="/decks"
            className="inline-flex min-h-11 items-center font-semibold text-[#2a6f97] hover:underline [&.active]:underline"
          >
            牌組攻略
          </Link>
        </nav>
      ...
      <footer className="mx-auto max-w-5xl px-4 pb-8 text-xs text-[#2a6f97]">
